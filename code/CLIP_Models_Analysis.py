...
Original file is located at
    https://colab.research.google.com/github/Ravi-Raghavan/ESE-5460-Final-Project/blob/master/notebooks/multimodal/CLIP/CLIP_Models_Analysis.ipynb
...
plot_attention_distribution(text_attention_array, predicted_labels, "Text")

plot_attention_distribution(image_attention_array, predicted_labels, "Image")

plot_attention_distribution(multimodal_attention_array, predicted_labels, "Multimodal")
...
attention_matrices_real = attention_matrices[predicted_labels == 1]
attention_matrices_fake = attention_matrices[predicted_labels == 0]
...
plt.title("Average Attention Weights: Real News")
...
sns.heatmap(avg_attn_weights_fake, annot=True, fmt=".2f", cmap="viridis",
            xticklabels=tokens, yticklabels=tokens, vmin=0, vmax=1)
plt.title("Average Attention Weights: Fake News")
plt.xlabel("Key Modality")
plt.ylabel("Query Modality")
plt.show()